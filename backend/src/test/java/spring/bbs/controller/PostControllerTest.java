...
//import spring.securitycontext.WithMockCustomUser;
//
...
//    private static final String specificPostUrl = "/api/v1/posts/{id}";
//    private static final String allPostsUrl = "/api/v1/posts";
...
//        @WithMockCustomUser(username = MEMBER_NAME, grade = "ROLE_USER")
...
//                .category("string")
//                .build();
//            given(postService.createPost(any(PostServiceRequest.class)))
//                .willReturn(expect);
//            //when //then
//            request(req)
//                .andExpect(status().isOk())
...
//            verify(postService).createPost(refEq(req.toServiceRequest("test")));
//        }
//
//        @Test
