...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = -707791624L;
    ...
    public final ListPath<spring.bbs.comment.domain.Comment, spring.bbs.comment.domain.QComment> commentList = this.<spring.bbs.comment.domain.Comment, spring.bbs.comment.domain.QComment>createList("commentList", spring.bbs.comment.domain.Comment.class, spring.bbs.comment.domain.QComment.class, PathInits.DIRECT2);
